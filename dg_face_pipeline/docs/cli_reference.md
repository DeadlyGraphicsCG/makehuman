...
| `--front-upright` / `--no-front-upright` | flag | on | Final Maya-facing guard that rotates the mesh in front-view XY space until MediaPipe eye landmarks 33 and 263 are horizontal. |
